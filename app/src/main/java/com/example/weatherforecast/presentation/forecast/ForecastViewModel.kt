...
class ForecastViewModel @Inject constructor(
    ...
    fun onCityButtonClick() {
        ...
        // TabRow
    private val _periodState: MutableState<TabRowSwitchable> = mutableStateOf(ForecastPeriodOptions.TODAY)
    ...
    private fun updateWbForToday() {  // были реализации лаконичнее раза в 3, пришлось поправить,
        if (_forecastState.value.forecasts.isNotEmpty()) {  //  сделать это красиво не успел :(
    ...
    fun setUserGeo(newState: Geo) {
        Log.d("asdfghh", newState.toString())
